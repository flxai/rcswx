...
def build_baseline(baseline, input_params=None, limits={"time": np.inf,"max_id": np.inf,"depth": np.inf,"memory": np.inf,"individual_memory": np.inf,"batch_pass_seconds": np.inf,}):
    """
    ...
    op_map = {
        ...
        "im2col7k1s3p" : "im2col(7, 1, 3)",
        "im2col2k2s0p" : "im2col(2, 2, 0)",
        "im2col4k4s0p" : "im2col(4, 4, 0)",
        ...
        "linear192": "linear(192)",
        "linear256": "linear(256)",
        "linear384": "linear(384)",
        "linear512": "linear(512)",
        "linear768": "linear(768)",
        "linear1024": "linear(1024)",
        "linear1536": "linear(1536)",
        "linear2048": "linear(2048)",
        "linear3072": "linear(3072)",
